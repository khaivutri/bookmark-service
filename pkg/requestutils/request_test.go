...
func newBindTestContext(t *testing.T, method, target, body, headerValue string) (*gin.Context, *httptest.ResponseRecorder) {
	t.Helper()
	...
	ctx.Request.Header.Set("X-Test-Header", headerValue)
...
func TestBindInputFromResquest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx, recorder := newBindTestContext(t, tt.method, tt.target, tt.body, tt.headerValue)
