...
func (_m *Repository) GetUserByID(ctx context.Context, userID string) (*model.User, error) {
...
func (_m *Repository) UpdateUser(ctx context.Context, _a1 *model.User) error {
